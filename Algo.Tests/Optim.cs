...
namespace Algo.Tests
{
    ...
    public class Optim
    {
        ...
        public void Cardinality()
        {
            ...
            foreach( Guest g in meeting.Guests )
            {
                cardinality *= g.ArrivalFlights.Count;
                cardinality *= g.DepartureFlights.Count;
            }
            Console.WriteLine(" Total cardinality: {0}", cardinality);
        }
    }
}
